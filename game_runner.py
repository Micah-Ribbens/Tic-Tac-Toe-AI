...
class Game:
    ...
    def draw_row_victory_line(self, index):
        """Draws the line that shows a row victory"""
    ...
    def draw_column_victory_line(self, index):
        """Draws the line that shows a column victory"""
    ...
    def get_all_board_types(self, game_board):
        """
            Returns: 
                list[int]: [rows, columns, diagonals]"""
    ...
    def get_square(self, row, column):
        """
            Returns:
                list[int]: [left_edge, top_edge, length, height, right_edge, bottom_edge] of the square of defined by the row and column"""
    ...
    def draw_x(self, row, column):
        """Draws a 'X' in the given square defined by the row and column"""
    ...
    def draw_circle(self, row, column):
        """Draws a circle in the given square defined by the row and column"""
    ...
    def draw_board_line(self, is_horizontal, square_number):
        """Draws a line of the Tic-Tac-Toe board"""
    ...
    def get_victory_line_indexes(self, board):
        """
            Returns:
                 list[int]: [index of draw_function, number that draw_function needs]"""
    ...
    def play_move(self, row, column):
        """Places a circle or X in the given square defined by the row and column"""
    ...
    def reset_board_elements(self, player1_has_won):
        """Resets the entire game (clears the game board)"""
    ...
    def get_valid_actions(self, board):
        """
            Returns:
                list[list[int]]: all the valid actions the AI can take
        """
    ...
    def play_middle_if_applicable(self, best_play, valid_actions):
        """Has the AI play the middle square if it is available"""
    ...
    def get_ai_start_data(self, is_maximizing):
        """
            Returns:
                list[object]: [beginning_best_score, play_type]; The starting values for the ai best_score and play_type"""
    ...
    def minimax(self, board, depth, is_maximizing):
        """
            Returns:
                int: the max score for taking the given action
        """
